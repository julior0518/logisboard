...
var useSpeechSynthesis = function useSpeechSynthesis(text) {
  ...
  var utter = react.useMemo(function () {
    return new SpeechSynthesisUtterance(text);
  }, [text]);

  var voiceOptions = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, defaultOptions), options);
  ...
  var speak = react.useCallback(function () {
